...
train_data = CatsDogsDataset(patient_list_txtfile='./binary/train1.txt',shuffle=True)
valid_data = CatsDogsDataset(patient_list_txtfile='./binary/test1.txt',shuffle=True)
...
# loss function
# weight=torch.tensor([1,1]).to(torch.float32).cuda()
