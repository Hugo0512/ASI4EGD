...
device='cuda'
model=torch.load('./six/COE/COE_best_six_model4.pth')
...
valid_data = CatsDogsDataset(patient_list_txtfile='./six/valid1.txt',patient_list_txtfile1='./six1/valid1.txt',shuffle=True)


valid_loader = DataLoader(dataset = valid_data, batch_size=1, shuffle=False)
model=model.to(device)
filename='CE_OE_six_best_valid_prob1.txt'
confusion_maxtrix_filename='CE_OE_six_best_valid_confusion_matrix1.txt'
all_prob=[]
